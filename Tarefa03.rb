class Tarefa03
   ...
   def initialize(nome)  # metodo contrutor que ira executar assim que programa inicializar,passando como parametro a variavel "nome"
   ...
   # como no exemplo : Tiago => Tia
    ...
    if @Nome.size % 2 == 1
       @valor_metade += 1
                      ...
                      #metodo que ira mostra a metade do nome 
   def mostra   
...
nome = gets.chomp.split('') # recebe os dados digitados pelo teclado,contudo a função "split" ira separa os dados um por um e guarda na variavel,transformando ela em um Array

class Tarefa06
   ...
   @Cont_regre = cont_regre   # uma nova variável tambem chamada "Cont_regre" ira recebera a variável "cont_regre" passada como parâmetro
   end 
   def mostra
...
cont_regre = gets.chomp.to_i                      # "cont_regre" irá armazenar o valor do tipo inteiro 
